...
namespace Store_Backend.Infraestructure.Specs
{
    public class Specification<T>
    {
            ...
            foreach (var criterion in _criteria)
            {
                ...
                switch (criterion.Operator)
                {
                    ...
                    case "MATCH":
                        ...
                        break;
                    case "MATCH_START":
                        predicate = Expression.Call(ToCaseInsensitiveStringExpression(property), "StartWith", null, ToCaseInsensitiveStringExpression(constant));
                        break;
                    case "MATCH_END":
        ...
        private MemberExpression GetProperty(Expression instance, string[] propertyNames, int index = 0)
        {
            ...
            if (index + 1 == propertyNames.Length) return property;
